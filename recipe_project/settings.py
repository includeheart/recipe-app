...
# Normalize and ensure local dev hosts are allowed (Django ignores ports)
...
INSTALLED_APPS = [
    ...
    'recipes',  # Custom app for managing recipes
    'home',    # Custom app for home and authentication views
    'search',  # Custom app for recipe search
]
